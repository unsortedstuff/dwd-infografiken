#!/usr/bin/env python3
"""Build station metadata for the static Tropennächte map page."""
...
TARGET_FILE = ROOT / "assets" / "stations_tropennaechte.json"


FILENAME_RE = re.compile(r"^dwd_tropennaechte_(?P<station_id>\d{5})_.+\.png$")
...
def main() -> None:
    ...
    for image_path in sorted(OUTPUT_DIR.glob("dwd_tropennaechte_*.png")):
